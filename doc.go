// Package spmc provides single-producer/multiple-consumer (SPMC) primitives for
...
//	q.Close() // consumers drain the backlog and then observe spmc.ErrClosed
//
...
//
//	b := spmc.NewBroadcaster[Event](spmc.WithCapacity(16))
